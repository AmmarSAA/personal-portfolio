...
export default function IntroPanel() {
  return (
    <div className="relative w-full select-none space-y-6 xl:w-1/2 2xl:w-6/12 2xl:space-y-8">
      <h2 className="text-5xl font-semibold font-secondary text-main sm:text-5xl md:text-6xl">
        Rahul
      </h2>
      <TypeWriterText />
      <p className="font-secondary text-base tracking-tight text-primary-foreground/70 sm:text-xl md:text-2xl 2xl:mr-10">
